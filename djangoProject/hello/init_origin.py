from hello.domains_origin import Member
from hello.models_origin import Quiz01Calcurator, Quiz03Grade, Quiz04GradeAuto, Quiz07RandomChoice, Quiz08Rps, Quiz09GetPrime, \
    Quiz10LeapYear, Quiz11NumberGolf, Quiz12Lotto, Quiz13Bank, Quiz14Gugudan, Quiz05Dice, Quiz02Bmi
from hello.quiz30_origin import Quiz30

if __name__ == '__main__':
    while 1:
        menu = input('0.Exit 1.계산기(+-*/) 2.Bmi 3.Grade 4.성적(등급까지) 5.주사위 6. 원하는범위에서1개숫자 7.멤버1명뽑기 '
                     '8.RPS 9.getPrime 10.윤년구하기 11.NumberGolf 12.Lotto 13.Bank입출금 \n'
                     '14.책받침구구단''30.List 31.tuple 32. dict')
        if menu == 0:
            break
        elif menu == '1':
...
# --------------------------------------------------------------
            ...
            q30 = Quiz30()
            print(q30.quiz30list())

        elif menu =='31':
            q31 = Quiz30()
            print(q31.quiz31tuple())
        elif menu == '32':
            q32 = Quiz30()
            print(q32.quiz32dict())